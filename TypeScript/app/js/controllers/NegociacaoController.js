System.register(["./../services/index", "../views/index", "../models/index", "../helpers/decorators/index", "../helpers/index"], function (exports_1, context_1) {
    "use strict";
        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                constructor() {
                    ...
                    this._service = new index_1.NegociacaoService();
                ...
                adiciona() {
                    ...
                    const negociacao = new index_3.Negociacao(dia, parseInt(this._inputQuantidade.val()), parseFloat(this._inputValor.val()));
